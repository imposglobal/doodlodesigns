...
const handleChange = (e) => {
  ...
  const sections = [
   ...
   // State to control the opening/closing of boxes
   ...
   // Toggle open/close of each box
   const toggleBox1 = () => setIsOpen1(!isOpen1);
...
<div className={styles.compsec}>
 ...
 <div className={styles.comprow}>
              {/*********************  Box 1 ****************************/}
        <div className={styles.row1} onClick={toggleBox1}>
          <div className={styles.innerWrapper}>
            <div className={styles.header}>
              <div className={styles.textContent}>
              <h2 className={`${styles.brandtitle} ${isOpen1 ? styles.openHeader : ''}`}>
                Brand Development
              </h2>
                {isOpen1 && (
              ...
              {/* <div className={styles.imageWrapper1}>
                        <Image
                          src="/home/services/branding/downarrow.png"
                          alt="Brand Development"
                          width={25}
                          height={15}
                          className="object-cover"
              ...
              {/*********************  Box 2 ****************************/}
        <div className={styles.row2} onClick={toggleBox2}>
          <div className={styles.innerWrapper}>
            <div className={styles.header}>
              <div className={styles.textContent}>
              <h2 className={`${styles.brandtitle} ${isOpen2 ? styles.openHeader : ''}`}>
              Brand Design
              </h2>                {isOpen2 && (
                  <div className={styles.sectionContent}>
                    <div className={styles.header}>
        ...
        {/*********************  Box 3 ****************************/}
        <div className={styles.row2} onClick={toggleBox3}>
          <div className={styles.innerWrapper}>
            <div className={styles.header}>
              <div className={styles.textContent}>
              <h2 className={`${styles.brandtitle} ${isOpen3 ? styles.openHeader : ''}`}>
              Logo Design
              </h2>                {isOpen3 && (
                  <div className={styles.sectionContent}>
                    <div className={styles.header}>
        ...
        {/*********************  Box 4 ****************************/}
        <div className={styles.row2} onClick={toggleBox4}>
          <div className={styles.innerWrapper}>
            <div className={styles.header}>
              <div className={styles.textContent}>
              <h2 className={`${styles.brandtitle} ${isOpen4 ? styles.openHeader : ''}`}>
              Brand Guidelines
              </h2>                {isOpen4 && (
                  <div className={styles.sectionContent}>
                    <div className={styles.header}>
        ...
        <div className={styles.row2} onClick={toggleBox5}>
          <div className={styles.innerWrapper}>
            <div className={styles.header}>
              <div className={styles.textContent}>
              <h2 className={`${styles.brandtitle} ${isOpen5 ? styles.openHeader : ''}`}>
              Brand Story Development
              </h2>                {isOpen5 && (
                  <div className={styles.sectionContent}>
                    <div className={styles.header}>
        ...
        <div className={styles.row6} onClick={toggleBox6}>
          <div className={styles.innerWrapper}>
            <div className={styles.header}>
              <div className={styles.textContent}>
              <h2 className={`${styles.brandtitle} ${isOpen6 ? styles.openHeader : ''}`}>
              Rebranding Services
              </h2>                {isOpen6 && (
                  <div className={styles.sectionContent}>
                    <div className={styles.header}>
